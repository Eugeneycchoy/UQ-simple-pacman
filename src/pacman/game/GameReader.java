...
public class GameReader {
    ...
    public static PacmanGame read(Reader reader) throws UnpackableException,
        ...
        try {
            ...
            game = readGame(betterReader, board);
            scores = readScores(betterReader);
        } catch (NullPointerException e) {
            throw new UnpackableException("File ended early");
        }
    ...
    private static Map<String, Integer> readScores(SmoothReader reader)
        ...
        if (line != null && line.isEmpty()) {
            throw new UnpackableException("Extra Blank Lines");
        }
